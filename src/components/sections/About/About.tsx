...
function About() {
    return(
        <div className="about">
            ...
            <br />
            <br />
            Motivé, rigoureux et créatif, je suis toujours prêt à relever de nouveaux défis et à collaborer sur des projets innovants. Mon objectif est de continuer à évoluer en tant que développeur, en construisant des solutions utiles, performantes et élégantes.
        </div>
    )
}
